...
def logging_setup():
    ...
    logging.getLogger("luigi.chimpflow_scheduler").setLevel("INFO")
    ...
    # All chimpflow database sql commands.
    # logging.getLogger("chimpflow_lib.chimpflow_databases.aiosqlite").setLevel("INFO")

    logging.getLogger("chimpflow_lib.chimpflow_contexts.classic").setLevel("INFO")
