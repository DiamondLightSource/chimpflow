...
class Index extends chimpflow__Page {
    #tabs_manager = null;
    #image_list_ux = null;
    #image_edit_ux = null;
    ...
    activate() {
        ...
        this.#tabs_manager = new chimpflow__TabsManager(
            self.runtime,
            "tabs_manager",
        ...
        this.#image_edit_ux = new chimpflow__ImageEditUx(
            self.runtime,
            "image_edit",
        ...
        this.#image_edit_ux.addEventListener(
            chimpflow__Events_IMAGE_PREVIOUS_OR_NEXT_EVENT,
