var chimpflow__PixelUx__UserMotionEvent = "chimpflow__PixelUx__UserMotionEvent";
var chimpflow__PixelUx__UserChangeEvent = "chimpflow__PixelUx__UserChangeEvent";

class chimpflow__PixelUx extends chimpflow__UxBase {
    SET_TARGET_POSITION = "chimpflow_guis::commands::set_target_position";
    ...
    set_autoid(autoid, target_position) {
        var F = "chimpflow__PixelUx::set_autoid"
    ...
    render(event) {
        var F = "chimpflow__PixelUx::render"
    ...
    handle_guide_motion_event(event) {
        var F = "chimpflow__PixelUx::handle_guide_motion_event"
    ...
    handle_guide_change_event(event) {
        var F = "chimpflow__PixelUx::handle_guide_change_event"
        ...
        var custom_event = new CustomEvent(chimpflow__PixelUx__UserChangeEvent,
            {
    ...
    update_database(event) {
        var F = "chimpflow__PixelUx::update_database"
