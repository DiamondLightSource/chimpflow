...
class chimpflow__TabsManager extends chimpflow__UxBase {
    COOKIE_NAME = "TABS_MANAGER";
    LOAD_TABS = "chimpflow_guis::commands::load_tabs";
    SELECT_TAB = "chimpflow_guis::commands::select_tab";
    TAB_ID_KEYWORD = "chimpflow_guis::keywords::tab_id"
    ...
    activate() {
        var F = "chimpflow__TabsManager::activate";
    ...
    _handle_tabs_created(jquery_event_object, ui) {
        var F = "chimpflow__TabsManager::_handle_tabs_created";

        console.log(F + ": tabs created");

        // Tell the index.js to notify the tabs about possible layout changes.
        var custom_event = new CustomEvent(chimpflow__Events_TABS_CREATED_EVENT,
            {
            });
    ...
    _load() {
        var F = "chimpflow__TabsManager::_load";
    ...
    switch_to_tab(tab_id) {
        var F = "chimpflow__TabsManager::switch_to_tab";
    ...
    _handle_tab_selected(jquery_event_object, ui) {
        var F = "chimpflow__TabsManager::_handle_tab_selected";
        ...
        var custom_event = new CustomEvent(chimpflow__Events_TAB_OPENED,
            {
    ...
    handle_ajax_success(response, status, jqXHR) {
        var F = "chimpflow__TabsManager::handle_ajax_success";
