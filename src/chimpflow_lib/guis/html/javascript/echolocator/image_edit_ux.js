...
class chimpflow__ImageEditUx extends chimpflow__UxAutoUpdate {
    COOKIE_NAME = "IMAGE_EDIT_UX";
    FETCH_IMAGE = "chimpflow_guis::commands::fetch_image";
    SET_IMAGE_IS_USABLE = "chimpflow_guis::commands::set_image_is_usable";
    ...
    activate() {
        var F = "chimpflow__ImageEditUx::activate"
        super.activate()
        ...
        this.#pixel_ux = new chimpflow__PixelUx(
            self.runtime,
            "pixel",
    ...
    set_autoid(autoid) {
        var F = "chimpflow__ImageEditUx::set_autoid";
    ...
    _handle_is_usable_change(is_usable) {
        var F = "chimpflow__ImageEditUx::_handle_is_usable_change";
    ...
    _handle_previous_or_next(direction) {
        var F = "chimpflow__ImageEditUx::_handle_previous_or_next";
    ...
    _handle_canvas_left_click(jquery_event_object) {
        var F = "chimpflow__ImageEditUx::_handle_canvas_left_click";
    ...
    _handle_canvas_right_click(jquery_event_object) {
        var F = "chimpflow__ImageEditUx::_handle_canvas_right_click";
    ...
    handle_ajax_success(response, status, jqXHR) {
        var F = "chimpflow__ImageEditUx::_handle_ajax_success";
    ...
    handle_spread_event(event) {
        var F = "chimpflow__ImageEditUx::handle_spread_event";
    ...
    render() {
        var F = "chimpflow__ImageEditUx::render";
    ...
    resize_image() {
        var F = "chimpflow__ImageEditUx::resize_image";
