...
class chimpflow__SystemHealthUx extends chimpflow__UxAutoUpdate {
    COOKIE_NAME = "SYSTEM_HEALTH_UX";
    GET_SYSTEM_HEALTH = "chimpflow_guis::commands::get_system_health";
    ...
    activate() {
        var F = "chimpflow__SystemHealthUx::activate";
    ...
    handle_ajax_success(response, status, jqXHR) {
        var F = "chimpflow__SystemHealthUx::_handle_ajax_success";
