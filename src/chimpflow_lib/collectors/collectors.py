...
class Collectors(Things):
    ...
    def lookup_class(self, class_type):
        ...
        if class_type == "dls_chimpflow_lib.chimpflow_collectors.aiohttp":
            from chimpflow_lib.collectors.aiohttp import Aiohttp

            return Aiohttp

        elif class_type == "dls_chimpflow_lib.chimpflow_collectors.manual":
            from chimpflow_lib.collectors.manual import Manual

            return Manual

        elif class_type == "dls_chimpflow_lib.chimpflow_collectors.scrape_to_database":
            from chimpflow_lib.collectors.scrape_to_database import ScrapeToDatabase
