...
from chimpflow_api.datafaces.context import Context as DatafaceContext
...
thing_type = "chimpflow_lib.chimpflow_datafaces.context"


class Context(ContextBase):
    """
    Asyncio context for a chimpflow_dataface server object.
    ...
    def __init__(self, specification):
        ...
        self.__api_chimpflow_dataface_context = None
    ...
    async def aenter(self):
        ...
        self.__api_chimpflow_dataface_context = DatafaceContext(self.specification())
        await self.__api_chimpflow_dataface_context.aenter()
    ...
    async def aexit(self):
        ...
        if self.__api_chimpflow_dataface_context is not None:
            await self.__api_chimpflow_dataface_context.aexit()
