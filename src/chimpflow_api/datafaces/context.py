...
from chimpflow_api.datafaces.datafaces import (
    Datafaces,
    chimpflow_datafaces_set_default,
)
...
class Context(ContextBase):
    """
    Client context for a chimpflow_dataface object.
    ...
    async def aenter(self):
        ...
        chimpflow_datafaces_set_default(self.interface)
    ...
    async def aexit(self):
        ...
        if self.interface is not None:
            ...
            chimpflow_datafaces_set_default(None)
